    ...
    <div className={styles.footer}>
      <div className={styles.list}>
        <ul>
          ...
          <li><a target="_blank" rel="noopener noreferrer" href="https://docs.google.com/forms/d/e/1FAIpQLSdfFG9fpzXMP6WqgHsgwiWIQPpqZ44HKUJyQXjSXOmYDWcfNA/viewform">공고제보</a></li>
          <li><p className={styles.wave}>💙</p></li>
        </ul>
      </div>
