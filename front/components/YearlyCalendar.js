          ...
          <div className={styles.gantt}>
              ...
              <div className={styles.gantt__row}>
                  ...
                  <ul className={styles.gantt__row__bars}>
                      <li className={classNames({[styles.calendar_entry]: true, [styles.oversize_list]: true})} style={{ gridColumn: `1/366`, backgroundColor: `#69A2F7`, zIndex: `3`}}>
                          <span className={styles.calendar_entry__date}>상시모집</span>
                          <span className={styles.calendar_entry__title}>지원</span>
                      </li>
                      <li className={styles.calendar_entry} style={{ gridColumn: `23/46`, backgroundColor: `#9CC2FA`, zIndex: `2` }}>
              ...
              <div className={styles.gantt__row}>
                  ...
                  <ul className={styles.gantt__row__bars}>
                      <li className={styles.calendar_entry} style={{ gridColumn: `179/204`, backgroundColor: `#9CC2FA`, zIndex: `3` }}>
                          <span className={styles.calendar_entry__date}>2-1기 : 6/29 ~ 7/24</span>
                          <span className={styles.calendar_entry__title}>Piscine</span>
                      </li>
                      <li className={styles.calendar_entry} style={{ gridColumn: `207/234`, backgroundColor: `#9CC2FA`, zIndex: `2` }}>
              ...
              <div className={styles.gantt__row}>
                  ...
                  <ul className={styles.gantt__row__bars}>
                      <li className={styles.calendar_entry} style={{ gridColumn: `241/267`, backgroundColor: `#9CC2FA`, zIndex: `3` }}>
                          <span className={styles.calendar_entry__date}>3-1기 : 8/31 ~ 9/27</span>
                          <span className={styles.calendar_entry__title}>Piscine</span>
                      </li>
                      <li className={styles.calendar_entry} style={{ gridColumn: `275/301`, backgroundColor: `#9CC2FA`, zIndex: `2` }}>
              ...
              <div className={styles.gantt__row}>
                  ...
                  <ul className={styles.gantt__row__bars}>
                      <li className={styles.calendar_entry} style={{ gridColumn: `129/149`, backgroundColor: `#69A2F7`, zIndex: `3` }}>
                          <span className={styles.calendar_entry__date}>5/11 ~ 5/25</span>
                          <span className={styles.calendar_entry__title}>지원</span>
                          <span className={styles.calendar_entry__details}><a>4기</a></span>
                      </li>
                      <li className={styles.calendar_entry} style={{ gridColumn: `155/175`, backgroundColor: `#9CC2FA`, zIndex: `2` }}>
              ...
              <div className={styles.gantt__row}>
                  ...
                  <ul className={styles.gantt__row__bars}>
                      <li className={styles.calendar_entry} style={{ gridColumn: `151/180`, backgroundColor: `#69A2F7`, zIndex: `3` }}>
                          <span className={styles.calendar_entry__date}>6/01 ~ 6/30</span>
                          <span className={styles.calendar_entry__title}>지원</span>
                          <span className={styles.calendar_entry__details}><a>4기</a></span>
                      </li>
                      <li className={styles.calendar_entry} style={{ gridColumn: `186/207`, backgroundColor: `#9CC2FA`, zIndex: `2` }}>
                      ...
                      <li className={styles.calendar_entry} style={{ gridColumn: `207/231`, backgroundColor: `#9CC2FA`, zIndex: `1` }}>
                          <span className={styles.calendar_entry__date}>7/27 ~ 8/21</span>
                          <span className={styles.calendar_entry__title}>챌린지</span>
                          <span className={styles.calendar_entry__details}><a>자세히보기</a></span>
                      </li>
                      <li className={classNames({[styles.calendar_entry]: true, [styles.oversize_list]: true})} style={{ gridColumn: `231/351`, backgroundColor: `#CBDFFD` }}>
              ...
              <div className={styles.gantt__row}>
                  ...
                  <ul className={styles.gantt__row__bars}>
                      <li className={styles.calendar_entry} style={{ gridColumn: `22/51`, backgroundColor: `#69A2F7`, zIndex: `3` }}>
                          <span className={styles.calendar_entry__date}>1/22 ~ 2/21</span>
                          <span className={styles.calendar_entry__title}>지원</span>
                          <span className={styles.calendar_entry__details}><a>4기</a></span>
                      </li>
                      <li className={styles.calendar_entry} style={{ gridColumn: `74/129`, backgroundColor: `#9CC2FA`, zIndex: `2` }}>
              ...
              <div className={styles.gantt__row}>
                  ...
                  <ul className={styles.gantt__row__bars}>
                      <li className={classNames({[styles.calendar_entry]: true, [styles.oversize_list]: true})} style={{ gridColumn: `1/366`, backgroundColor: `#5C4DFF`, zIndex: `1`, opacity: `0.2` }}>
              ...
              <div className={styles.gantt__row}>
                  ...
                  <ul className={styles.gantt__row__bars}>
                      <li className={styles.calendar_entry} style={{ gridColumn: `77/107`, backgroundColor: `#69A2F7`, zIndex: `1` }}>
